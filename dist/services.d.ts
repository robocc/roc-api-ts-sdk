...
export declare abstract class ServicesMixin extends BaseAPI {
    ...
    */
    SetMissionPriority(d: SetMissionPriorityParams): Promise<null>;
    /**
    * **Remove mission**
    *
    * Remove mission
    ...
    */
    AddRocUser(d: AddRocUserParams): Promise<number>;
    /**
    * **Update ROC user**
    *
    * Update ROC user
    ...
    */
    SetDelayBeforePromotingMission(d: number): Promise<null>;
    /**
    * **Set use sync buttons**
    *
    * Allow to sync all buttons in same time
    ...
    */
    SetUseSyncButtons(d: SetUseSyncButtonsParams): Promise<null>;
    /**
    * **Allow go to charge with crate**
    *
    * Allow go to charge with crate
    ...
    */
    AllowChargeWithCrate(d: boolean): Promise<null>;
}

...
import { Site, SiteLight, SiteRaw, Map, MapRaw, MapElements, MapWithoutImages, ForbiddenArea, CustomArea, SavedPose, ChargingStation, DockedPose, Marker, TeleopCmd, User, DiagnosticElement, SoundScenarioVolume, WifiAp, Group, ButtonConfig, WaitingPose, CustomCommand, ControllerLora, MapElementRestriction, DockedPoseConfig, RocMapElementConfig, VehDelayConfig, DailyStats, StatsData, ExportedStats, RocUser, VehTimelineData, ModuleParams, ManagerMap, SubscribeResult, FollowMeParams, AuthUserResult, LoginParams, LoginResult, ExportSitesParamsItem, ExportSitesResultItem, UpdateChargingStationConfigParams, UpdateDockedPoseConfigParams, SetUserParams, SetObtCbtParams, SetChargingStationResult, SetSavedPoseResult, SetDockedPoseResult, SetForbiddenAreaResult, SetCustomAreaResult, CheckPoseParams, Check3dBoxParams, SimAddShelfParams, SetCustomLedParams, SetCustomSoundParams, MappingGetLastResult, SimSetDiffDriveStateParams, SetScenarioSoundMaxVolumeParamsItem, SetModuleParamsParams, NetworkRedirectPortParams, SystemRestartParams, AddCallButtonParams, AddRestockingButtonParams, AddMultidestinationButtonParams, AddOrderedMultidestinationButtonParams, AddVehParams, AddPortRedirectionParams, UpdatePortRedirectionParams, DeletePortRedirectionParams, ControllerLoraSetContactConfigParams, NextStepMissionWithMessageParams, SetMultidestinationParams, SetMultidestinationWithMessagesParams, GetStatsParams, GetLightStatsParams, ExportStatsParams, GetVehsTimelineParams, AddRocUserParams, UpdateRocUserParams, CreateMissionParams, ExtendMissionParams, StartButtonMissionParams, EnableFollowMeParams } from "./types";
...
export declare abstract class ServicesMixin extends BaseAPI {
    ...
    */
    MappingGetLast(): Promise<DeepRequired<MappingGetLastResult>>;
    /**
    * **Stop navigation**
    *
    * Stop the navigation on the vehicle, it will no longer be able to move autonomously ⛔
    ...
    */
    SetTabletInCharge(d: boolean): Promise<null>;
    /**
    * **Ignore plugged tablet required**
    *
    * Ignore plugged tablet required
    ...
    */
    IgnorePluggedTabletRequired(): Promise<null>;
    /**
    * **Set vehicle direction**
    *
    * Set vehicle direction
    ...
    */
    LiftSetHaveBoxOn(d: boolean): Promise<null>;
    /**
    * **Set min height of lift**
    *
    * Set min height of lift
    ...
    */
    LiftSetMinHeight(d: number): Promise<null>;
    /**
    * **Set max height of lift**
    *
    * Set max height of lift
    ...
    */
    LiftSetMaxHeight(d: number): Promise<null>;
    /**
    * **Set tare height of lift**
    *
    * Set tare height of lift
    ...
    */
    EnableFollowMe(d: EnableFollowMeParams): Promise<null>;
    /**
    * **Allow follow me**
    *
    * Allow follow me
